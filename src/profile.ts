...
export const REQUIRED_PROFILE_FILES = ["architecture.md", "services.yaml", "init.sh", "harness.md", "delivery.json", "library/conventions-map.md", "library/coding-principles.md"] as const;
